...
export async function askTeluguAIAssistant(
  ...
  if (lower.includes('ధర') || lower.includes('రేటు') || lower.includes('apmc')) {
    return 'ఆంధ్రప్రదేశ్ మార్కెట్ యార్డుల తాజా సమాచారం ప్రకారం టమోటా కిలో ₹25, మిర్చి కిలో ₹65, ఉల్లిపాయ కిలో ₹20 నడుస్తోంది. మీ పంట నాణ్యతను బట్టి సరసమైన ధర నిర్ణయించండి.';
  }
  if (lower.includes('ఎస్క్రో') || lower.includes('డబ్బు') || lower.includes('సేఫ్') || lower.includes('భద్రత')) {
    return 'ఫార్మ్‌డైరెక్ట్ ఎస్క్రో పూర్తిగా సురక్షితం. కొనుగోలుదారు చెల్లించిన డబ్బు ప్రత్యేక ఖాతాలో ఉంటుంది. పంట చేతికి అంది నిర్ధారణ జరిగేవరకు రైతుకు విడుదల కాదు.';
  }
  if (lower.includes('అమ్మ') || lower.includes('నమోదు') || lower.includes('రైతు')) {
    return 'పంట అమ్మడానికి పైన ఉన్న "పంట నమోదు చేయండి" బటన్ నొక్కండి. మీ పంట పేరు, ఎన్ని కిలోలు, కిలో ధర చెప్పండి.';
  }
  if (lower.includes('కొన') || lower.includes('వ్యాపారి') || lower.includes('మార్కెట్')) {
    return 'తాజా పంటలు కొనడానికి మార్కెట్‌లోని పంటల జాబితాను చూడండి. రైతుతో నేరుగా చాట్ చేసి సరసమైన ధరకు ఆర్డర్ ఇవ్వండి.';
  }

  return 'నమస్కారం! నేను ఫార్మ్‌డైరెక్ట్ రైతు మిత్రను. మీకు పంట అమ్మడంలో లేదా కొనడంలో ఏ సహాయం కావాలో చెప్పండి.';
}
